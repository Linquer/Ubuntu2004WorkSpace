...
class Config:
     def __init__(self) -> None:
        ...
        self.max_steps = 1800 # 每个回合的最大步数
        self.eval_eps = 4 # 评估的回合数
        self.eval_per_episode = 10 # 评估的频率
        self.epsilon_start = 0.9 # epsilon初始值
        self.epsilon_end = 0.1 # epsilon最终值
        self.epsilon_decay = 100000 # epsilon衰减率

        self.train_batch_size = 3 # 每次训练前收集多少轮数的数据
        self.gamma = 0.9 # 折扣因子
        self.k_epochs = 1 # 更新策略网络的次数
        self.actor_lr = 0.0007 # actor网络的学习率
